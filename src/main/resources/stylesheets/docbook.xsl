...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:import href="../../lib/xsl/fo/highlight.xsl"/>
    ...
    <xsl:param name="body.font.small">7</xsl:param>
    ...
    <xsl:param name="highlight.xslthl.config">src/main/lib/xsl/highlighting/xslthl-config.xml</xsl:param>
    ...
    <xsl:attribute-set name="table.table.properties">
        <xsl:attribute name="border-before-width.length">1pt</xsl:attribute>
        <xsl:attribute name="border-after-width.length">1pt</xsl:attribute>
    ...
    <xsl:attribute-set name="monospace.verbatim.properties">
        <xsl:attribute name="font-size">
            <xsl:value-of select="$body.font.small * 0.75"/>
            <xsl:text>pt</xsl:text>
        </xsl:attribute>
